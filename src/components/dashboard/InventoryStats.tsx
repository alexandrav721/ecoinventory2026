...
const InventoryStats = () => {
  ...
  const statCards = [
    ...
    },
    {
      ...
      tooltip: "This is what your current inventory could sell for based on actual sale prices from similar items across Loop. We analyze sold items by category to estimate your earning potential.",
